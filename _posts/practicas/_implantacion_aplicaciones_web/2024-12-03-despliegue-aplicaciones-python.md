...
date:   2024-11-28 01:00:00 +0200
categories: implantacion
tag: [Python, django, Apache2, Nginx, servidor web, LEMP, LAMP, implantacion, Implantación de Aplicaciones Web]
excerpt: En este post se recoge una breve guía para la implantación de aplicaciones escritas en Python usando el framework Django.
---

# Configuración del equipo de desarrollo para desplegar una aplicación Python con Django
